                ...
                <div className="navbar-container flex flex-row gap-5 p-2.5 w-auto">
                    <h3 className="font-bold">
                        <a className="navbar-title" href="#home">
                            <span className="title-k underline text-3xl">K</span>evin Pratama
                        </a>
                    </h3>
                 ...
                 <ul className="flex flex-row items-end gap-2.5 p-2.5 pt-5">
                    ...
                    <li><a className="hover:text-gray-400 text-white" href="https://www.linkedin.com/in/kevin-pratama-9454b0250/"><GitHubIcon style={{ fontSize: 18 }}></GitHubIcon></a></li>
                    <li><a className="hover:text-gray-400 text-white" href="https://github.com/kevinma21/"><LinkedInIcon style={{ fontSize: 18 }}></LinkedInIcon></a></li>
                </ul>
            </div>
        </div>
    );
